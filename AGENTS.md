...
| **Storm Tracking & Nowcast** | [`src/ml/storm-tracker.ts`](file:///c:/Users/franc/Documents/hailcast-ml/src/ml/storm-tracker.ts) | ✅ Completed | Motion vectors, 15-60m cones and ETA per coordinates |
...
| **Spotter Feed & Modal** | [`src/components/SpotterModal.ts`](file:///c:/Users/franc/Documents/hailcast-ml/src/components/SpotterModal.ts) | ✅ Completed | Interactive form with visual hail comparators |
